...
export const LayoutBarmobile: React.FC<LayoutBarmobileProps> = ({
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-[150] bg-white/95 dark:bg-black/95 backdrop-blur-md border-t border-gray-100 dark:border-zinc-900 flex justify-around items-center px-2 py-2 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
      {/* Início */}
      <button 
